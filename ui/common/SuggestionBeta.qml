...
Item {
    ...
    property var suggestionToText: (suggestion) => suggestion.raw[root.filterRoleName]
    ...
    readonly property QtObject proxyModel: SortFilterProxyModel {
        ...
        proxyRoles: ExpressionRole {
            name:  root.filterRoleName
            expression: model.raw[root.filterRoleName]
        }
        ...
        Keys.onPressed: {
            ...
            case Qt.Key_Return:
                if (suggestions.currentIndex !== -1) {
                    const selection = proxyModel.get(suggestions.currentIndex)
        ...
        Popup {
            ...
            ListView {
                ...
                delegate: ItemDelegate {
                    ...
                    onClicked: {
                        const selection = proxyModel.get(index)
